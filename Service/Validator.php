...
use ValidatorBundle\Exception\InvalidDataException;
use ValidatorBundle\Response\ValidatorResponse;
use InvalidParameterValueException;
use Symfony\Component\DependencyInjection\Container;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\HttpFoundation\Request;
use Respect\Validation\Validator as RValidator;
...
class Validator
{
    ...
    /**
     * Data property for handle variables.
     *
     * @var array
     */
    protected $data = [];
    ...
    /**
     * Default credentials if the credentials is not given.
     *
     * @Serializer\Exclude()
     */
    ...
    public function __construct(Container $container, array $rules = null)
    {
    ...
    public function loadRules($file = '../src/ValidatorBundle/Resources/default_validator_rules.yml')
    {
    ...
    {
        if(!array_key_exists($field, $this->rules)) throw new \InvalidArgumentException("Geçersiz argüman tipi.", 500);
    ...
    public function validate($request, array $configs = null, string $requestType = null, $previous = null)
    {
        ...
        if(!is_null($configs) && is_array($configs) && count($configs) > 0) {
            $credentials = $configs;
        }else{
